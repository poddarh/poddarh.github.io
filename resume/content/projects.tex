  ...
  \cventry
    ...
    {Nov. 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        ...
        \item Created a Slack Bot written in NodeJS that replied with images produced from {\fontfamily{ptm}\selectfont \LaTeX } code sent with the ability to update code.
      \end{cvitems}
    }
